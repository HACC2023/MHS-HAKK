    ...
    return (
        <>
            <div className="overflow-x-hidden">
                ...
                {/* Nav bar */}
                <div className="sticky top-0 w-screen h-16 flex flex-row text-black bg-white border-gray-500 border-b overflox-x-hidden scrollbar-hide">
                    <div className="flex flex-row w-4/12 font-bold">
                        <img className="h-9 my-auto mx-6" src="https://upload.wikimedia.org/wikipedia/en/b/bf/Tyler_Technologies_logo.svg"></img>
                        {/* <div className="h-12 w-24 bg-black text-white flex items-center justify-center my-auto mx-6 rounded-md">Logo</div> */}
                        <button className="w-16 h-12 bg-black text-white inline-flex items-center justify-center rounded-md my-auto mx-6 hover:bg-gray-800">
                    ...
                    <div className="flex flex-row w-4/12 justify-end">
                        <a target="_blank" href="https://medquest.hawaii.gov/en/faq.html" className="h-12 w-28 border border-gray-500 text-black flex items-center justify-center text-center my-auto mx-3 rounded-md hover:bg-gray-200">Medquest Elegibility</a>
                ...
                <div className="h-96 overscroll-none overflow-hidden">
                    ...
                    <img className="w-screen" src="https://c8.alamy.com/comp/D0DCNJ/white-peak-mountains-D0DCNJ.jpg"></img>
                </div>
                <div className="bg-white">
                    ...
                    <div className=" flex flex-row justify-center">
                        ...
                        <a href="" className="mx-9 w-48 h-28 flex rounded-md text-center justify-center items-center bg-red-600 hover:bg-red-500 border-4 border-red-700 text-xl p-5 text-black font-semibold">I do not have insurance</a>
                    </div>
                </div>
                <div>
