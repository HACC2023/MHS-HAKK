        ...
        <>
            ...
            <div className="font-tyler">
                ...
                <div className="flex flex-co mb-10 pt-14 ">
                    ...
                    <div className="w-1/2">
                        <img className="h-full w-3/4 object-cover" alt="Image of Hawaii" src="https://images.unsplash.com/photo-1591068929753-4d1cf8fc6ff7?auto=format&fit=crop&q=80&w=1932&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"/>
                    </div>
                </div>
            </div>
            <Footer/>
