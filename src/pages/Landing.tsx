                ...
                <div className="flex flex-co mb-10 pt-14 ">
                    <div className="w-1/2 pl-60 pr-24">
                        ...
                        <div className="flex justify-center">
                            <a className="btn  text-lg font-semibold mt-2 h-14 bg-light-green hover:bg-hover-green text-green-gray border-0" target="_blank" href="https://humanservices.hawaii.gov/mqd/quest-overview/">Med-QUEST eligibilty</a>
                        </div>
                    </div>
                    <div className="w-1/2">
