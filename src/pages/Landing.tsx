        ...
        <>
            ...
            <div className="h-80 w-full bg-dark-blue flex flex-row">
                <div className="ml-60 pt-16 w-2/3">
                    ...
                    <Link href="/Search" className="mt-3 btn h-16 text-xl bg-light-green hover:bg-hover-green text-green-gray border-0 ">Start now</Link>
                </div>
            </div>
            <div className="flex flex-co mb-10 pt-14 ">
                <div className="w-1/2 pl-60 pr-24">
                    ...
                    <p className="text-xl font-medium pt-2 pl-10">Review the list of the clinics their information.</p>
                    ...
                    <div className="flex justify-center">
                        <a className="btn text-lg font-semibold mt-2 h-16 bg-light-green hover:bg-hover-green text-green-gray border-0" target="_blank" href="https://humanservices.hawaii.gov/mqd/quest-overview/">Med-QUEST eligibilty</a>
                    </div>
                </div>
                <div className="w-1/2">
